export let slider = {
        ...
        return `
            <div class="oc-area">
                <div class="oc-pos-rel">
                    <div class="sliderContent oc-h-640 oc-wp-100 oc-pointer-event-none">
                        ${titles.map((t, idx) => `
    ...
    js(ele) {
        ...
        return
        function ani(idx) {
            [...sliderContent.children].forEach(c => c.style.display = 'none')
            sliderContent.children[idx].style.display = 'flex'
        }
    }
}